    ...
    <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
        ...
        @foreach(Auth::user()->unreadNotifications as $notification)
            <a class="dropdown-item d-flex align-items-center" href="{{route('enotifications.show',$notification->id)}}">
                <div class="mr-3">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="{{route('enotifications.index')}}">Show All Notifications</a>
      </div>
</div>
